...
def get_args():
    ...
    parser.add_argument('--dataset', type=str, default='cifar10', choices=["cifar10", "fmnist", "kmnist", "cifar100", "svhn", "covertype", "speechcommands"], help='dataset used for training')
    ...
    parser.add_argument('--lr', type=float, default=0.01, help='learning rate (default: 0.01)') #LR = 0.01 for SGD - 0.1 for IVON 
    ...
    parser.add_argument('--process', type=int, default=10, help='number of parallel process')
    parser.add_argument('--desc', type=str, default="", help='Description of run')

    parser.add_argument('--pretrained', type=bool, default=False, help='Whether to use pretrained models') 
    parser.add_argument('--pretrained_logdir', type=str, help='The logdir of pretrained models') 
    
    parser.add_argument('--nbl', type=int, default=3, choices=[1,2,3], help='Number of Bayesian layers')
    ...
    parser.add_argument('--hess_init', type=float, default=1e-2, help='Parameter initializing the hessian in IVON optimizer')
    ...
    for key, value in experiment_dict[args.experiment].items():
